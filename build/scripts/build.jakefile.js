...
(function() {
	...
	task("buildClient", [ paths.clientDistDir, "bundleClientJs" ], function() {
		...
		shell.cp(paths.clientDir + "/*.html", paths.clientDir + "/*.png" , paths.clientDir + "/type/*.*" , paths.clientDir + "/*.ico",  paths.clientDir + "/js/vendor/*.*", paths.clientDir + "/img/*.*", paths.clientDir + "/css/*.*", paths.clientDistDir);
	});
